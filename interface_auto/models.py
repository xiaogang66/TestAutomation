...
class InterfaceParam(models.Model):
    ...
    belong_menu = models.CharField(max_length=256,null=True,verbose_name='所属菜单')
...
class InterfaceCase(models.Model):
    ...
    case_no = models.CharField(max_length=250,verbose_name='用例编号',db_index=True,unique=True)
    ...
    url = models.CharField(max_length=256,verbose_name='请求地址')
    request_method = models.IntegerField(default=1,verbose_name='请求方法（1get，2post）')
    content_type = models.IntegerField(default=1,verbose_name='内容类型（1json，2form表单，3xml）')
    ...
    assert_type = models.IntegerField(default=1,verbose_name='断言类型(1相等，2包含，3正则)')
    assert_partern = models.TextField(max_length=100000,null=True,verbose_name='断言值/表达式')
...
class InterfaceSuit(models.Model):
    ...
    builder = models.CharField(max_length=256,null=True,verbose_name='创建人')
    interface_case = models.ManyToManyField('InterfaceCase',verbose_name='测试用例')
